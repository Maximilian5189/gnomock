// Package postgis includes postgis implementation of Gnomock Preset interface.
// This Preset can be passed to gnomock.Start() function to create a configured
// postgis container to use in tests.
package postgis
...
const defaultVersion = "11-2.5-alpine"

func init() {
	registry.Register("postgis", func() gnomock.Preset { return &P{} })
}

// Preset creates a new Gmomock PostGIS preset. This preset includes a Postgres
...
func (p *P) Image() string {
	return fmt.Sprintf("docker.io/postgis/postgis:%s", p.Version)
}
